...
function setup() {
  ...
  // powerup for levels
  powerUp = new Sprite(powerUpImage);
  powerUp.scale = 0.2;
...
function levelOne() {
  ...
  world.gravity.y = 20;
   ...
   //stopwatch
   text("Time: "+stopwatch+"seconds", 50, 50)
  ...
  player.collided(powerUp , powerUpActivate);
}
...
function levelTwo() {
  ...
  //stopwatch
  text("Time: "+stopwatch+"seconds", 50, 30)
 ...
 if (player.collided(cheese1) === true) {
  ...
  //making powerUp subtract 3 seconds from stopwatch if collided with
  player.colliding(powerUp  , powerUpActivate);
...
function levelThree() {
  ...
  //making powerUp subtract 3 seconds from stopwatch if collided with player
  player.colliding(powerUp  , powerUpActivate);
}
